...
typedef enum {
    ...
    IDX_PASSED_BLOCKED = IDX_PASSED_THEIR_KING_DIST + 24,
    IDX_PASSED_SAFE_ADVANCE = IDX_PASSED_BLOCKED + 4,
    IDX_PAWN_THREAT = IDX_PASSED_SAFE_ADVANCE + 4,
    IDX_KNIGHT_THREAT = IDX_PAWN_THREAT + 5,
    IDX_BISHOP_THREAT = IDX_KNIGHT_THREAT + 5,
    IDX_ROOK_THREAT = IDX_BISHOP_THREAT + 5,
    IDX_QUEEN_THREAT = IDX_ROOK_THREAT + 5,
    IDX_HANGING_PAWN = IDX_QUEEN_THREAT + 5,
    IDX_FAR_KNIGHT,
    IDX_FAR_BISHOP,
    IDX_FAR_ROOK,
    IDX_FAR_QUEEN,
