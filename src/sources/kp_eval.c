...
const Scorepair PassedOurKingDistance[24] = {
    SPAIR(  23,   95), SPAIR(  35,    5), SPAIR( -31,  -86),
    SPAIR(   0,    0), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR(  30,   70), SPAIR(  39,   16), SPAIR(  17,  -38),
    SPAIR( -63,  -60), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR(   5,   68), SPAIR( -28,   36), SPAIR( -14,  -11),
    SPAIR(  -4,  -42), SPAIR(  38,  -53), SPAIR(   0,    0),
    SPAIR( -43,   54), SPAIR( -27,   31), SPAIR( -11,   -9),
    SPAIR(   0,  -14), SPAIR(  27,  -22), SPAIR(  42,  -28)
};

const Scorepair PassedTheirKingDistance[24] = {
    SPAIR(  13, -150), SPAIR(   6,    2), SPAIR(   5,  162),
    SPAIR(   0,    0), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR( -23, -119), SPAIR(  22,  -46), SPAIR(  14,   43),
    SPAIR(   7,  114), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR( -14,  -77), SPAIR(  25,  -37), SPAIR(  16,  -10),
    SPAIR(  -3,   46), SPAIR( -29,   77), SPAIR(   0,    0),
    SPAIR( -48,  -34), SPAIR( -15,   -9), SPAIR(  17,  -10),
    SPAIR(  31,   -6), SPAIR(  -1,   36), SPAIR(   0,   35)
};
